...
impl Lcdc {
    ...
    pub fn display_bg(&self) -> bool {
        ((self.0 >> Lcdc::BG_DISPLAY_BIT_POS) & 0b1) != 0
    }

    pub fn display_window(&self) -> bool {
        ((self.0 >> Lcdc::WINDOW_DISPLAY_BIT_POS) & 0b1) != 0
    }

    pub fn display_sprite(&self) -> bool {
        ((self.0 >> Lcdc::SPRITE_DISPLAY_BIT_POS) & 0b1) != 0
    }

    pub fn sprite_height(&self) -> u8 {
        match ((self.0 >> Lcdc::SPRITE_SIZE_BIT_POS) & 0b1) != 0 {
            true => 16,
            false => 8,
        }
    }
    ...
    pub fn window_tile_map(&self) -> super::tiling::TileMap {
        match ((self.0 >> Lcdc::WINDOW_TILE_MAP_SELECT_BIT_POS) & 0b1) != 0 {
    ...
    pub fn bg_tile_map(&self) -> super::tiling::TileMap {
        match ((self.0 >> Lcdc::BG_TILE_MAP_SELECT_BIT_POS) & 0b1) != 0 {
            true => super::tiling::TileMap::new(0x1C00), // 9C00-9FFF
            false => super::tiling::TileMap::new(0x1800), // 9800-9BFF
        }
    }
    ...
    pub fn bg_and_window_tile_data_map(&self) -> super::tiling::TileDataMap {
        match ((self.0 >> Lcdc::BG_AND_WINDOW_TILE_DATA_SELECT_BIT_POS) & 0b1) != 0 {
            true => {
    ...
    pub fn lcd_enabled(&self) -> bool {
        ((self.0 >> Lcdc::LCD_ENABLE_BIT_POS) & 0b1) != 0
    }
}
...
impl Stat {
    ...
    pub fn hblank_interrupt_enabled(&self) -> bool {
        ((self.0 >> Stat::HBLANK_INTERRUPT_BIT_POS) & 0b1) != 0
    }

    pub fn vblank_interrupt_enabled(&self) -> bool {
        ((self.0 >> Stat::VBLANK_INTERRUPT_BIT_POS) & 0b1) != 0
    }

    pub fn oam_scanning_interrupt_enabled(&self) -> bool {
        ((self.0 >> Stat::OAM_SCANNING_INTERRUPT_BIT_POS) & 0b1) != 0
    }

    pub fn lyc_interrupt_enabled(&self) -> bool {
        ((self.0 >> Stat::LYC_INTERRUPT_BIT_POS) & 0b1) != 0
    }
}
